...
if(DOCKER)
  ...
  set(PKG_OUTPUT_DIR ${CMAKE_CURRENT_SOURCE_DIR}/packages)
  ...
  if(is_linux)
    ...
    execute_process(COMMAND id -nu
      OUTPUT_VARIABLE DOCKER_USERNAME
      OUTPUT_STRIP_TRAILING_WHITESPACE)
    message(STATUS "docker local username: ${DOCKER_USERNAME}")
  endif()
  if(DOCKER_USER_ID AND DOCKER_GROUP_ID AND DOCKER_USERNAME)
    set(map_user TRUE)
  endif()
  #[===================================================================[
      rpm
  ...
  add_custom_target(rpm_container
    ...
    SOURCES
      ...
      ${rippled_SOURCE_DIR}/bin/getRippledInfo
  )
  ...
  add_custom_target(rpm
    docker run
      ...
      -v ${rippled_SOURCE_DIR}:/opt/rippled_bld/pkg/rippled
